...
class MovieManagerTest {
    ...
    MovieData movieTwelve = new MovieData(12, "Interstellar");
    MovieData movieThirteen = new MovieData(13, "Coco");
    MovieData movieFourteen = new MovieData(14, "Back to the Future");
    MovieData movieFifteen = new MovieData(15, "WALL-E");
    MovieData movieSixteen = new MovieData(16, "The Dark Knight");
